...
if __name__ == '__main__':
    ...
    run_batch(also_plot, base_seed, 'ALL', 700, 1.0, 0.96,
              num_simulations=3,
              min_set_size=5, max_set_size=61, number_of_pairs=50)

    # run_batch(also_plot, base_seed, 'NONE', 1500, 1.0, 0.93,
    #      num_simulations=10,
    #      min_set_size=5,
    #      max_set_size=61,
    #      number_of_pairs=50)
    ...
    #
    # run_batch(also_plot, base_seed, 'BETWEEN_WITH_DYNAMIC_UNIVERSE_SIZE', 2500, 1.0, 0.95,
    #      num_simulations=10,
